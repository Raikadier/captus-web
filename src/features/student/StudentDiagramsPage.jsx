    ...
    <div className="p-6 space-y-6">
      <div className="bg-card rounded-xl shadow-sm p-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Mis Diagramas</h1>
            <p className="text-sm text-muted-foreground">Crea y gestiona tus propios diagramas de estudio</p>
          </div>
        </div>
      ...
      {loading && diagrams.length === 0 ? (
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-foreground">No tienes diagramas aún</h3>
            ...
            <Card key={diagram.id} className="flex flex-col overflow-hidden hover:shadow-md transition-shadow">
              ...
              <CardFooter className="pt-4 border-t bg-muted/50 flex justify-between">
                 ...
                 <div className="flex gap-2">
                   ...
                   <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive hover:bg-destructive/10" onClick={() => handleDeleteClick(diagram.id)}>
